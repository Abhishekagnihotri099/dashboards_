            ...
            for row in reader:
                ...
                if not dsoutcome.objects.filter(audit_id=row['audit_id']).exists():
                    dsoutcome.objects.create(
                        ...
                        assigned_date=parse_datetime(row['assigned_date']) if row['assigned_date'] != 'NULL' else None,
                        ...
                        close_date=parse_datetime(row['close_date']) if row['close_date'] != 'NULL' else None,
                        ...
                        created_date=parse_datetime(row['created_date']) if row['created_date'] != 'NULL' else None,
                        ...
                        month_begin=parse_datetime(row['month_begin']) if row['month_begin'] != 'NULL' else None,
                        ...
                        reconsideration_date=parse_datetime(row['reconsideration_date']) if row['reconsideration_date'] != 'NULL' else None,
                        ...
                        signal_close_date=parse_datetime(row['signal_close_date']) if row['signal_close_date'] != 'NULL' else None,
                        ...
                        week_begin=parse_datetime(row['week_begin']) if row['week_begin'] != 'NULL' else None,
